...
##
# def tutorial_point():
# PATH = "C:/Users/HP/Desktop/scraper/chromedriver.exe"
...
##
##
# new_big_template = soup.find('div', class_='mui-col-md-6 tutorial-content')
# btn3 = soup.find('div', class_="qa_category")
# try:
# btn3.clear()
# except:
...
# None
##
# btn6 = soup.find('div', class_="mui-container-fluid button-borders show")
# try:
# btn6.clear()
# except:
# None
