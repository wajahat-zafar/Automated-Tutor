...
#     def generate(
#         self, article: str, num_questions: bool = None, answer_style: str = "sentences"
#     ):
...
#     def generate_qg_inputs(self, text: str, answer_style: str):
...
#     def generate_questions_from_inputs(self, qg_inputs: List):
#         generated_questions = []
...
#     def _prepare_qg_inputs(self, sentences: List[str], text: str):
#         inputs = []
#         answers = []
...
#         self, generated_questions, qg_answers, scores, num_questions
#     ):
